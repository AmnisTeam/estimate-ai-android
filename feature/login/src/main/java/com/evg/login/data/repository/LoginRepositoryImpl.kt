...
import com.evg.login.domain.mapper.toUserDTO
...
class LoginRepositoryImpl(
    ...
    override suspend fun loginUser(user: User): ServerResult<String, CombinedLoginError> {
        return apiRepository.loginUser(user = user.toUserDTO())
    }
}